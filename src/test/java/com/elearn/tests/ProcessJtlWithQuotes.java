...
public class ProcessJtlWithQuotes {

	private static int PARTS = 10;
	private static String FILENAME = "bcpFinal-1448463309-complete";
	private static String PATH = "D:/Xyleme/performance/products/bcp/tests/25-Nov-2015/TEST_1/";
